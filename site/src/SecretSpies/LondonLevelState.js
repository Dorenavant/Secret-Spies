...
(function (undefined) {
    ...
    p.preload = function () {
        ...
        this.load.image("LondonLevelState/ui/questionPanel", assets.common.child("ui/mediumMenu.png"));
        this.load.image("LondonLevelState/ui/correctAnswer", assets.common.child("ui/correctAnswer.png"));
        this.load.image("LondonLevelState/ui/wrongAnswer", assets.common.child("ui/wrongAnswer.png"));
        this.load.image("LondonLevelState/ui/defaultAnswer", assets.common.child("ui/defaultAnswer.png"));
    ...
    function hitQuestionBox(body1, body2) {
        ...
        var questionPanel = this.add.sprite(center.x, center.y, "LondonLevelState/ui/questionPanel");
        var panelSize = {
            width: 400,
            height: 400
        };
        ...
        var genButton = function(text, correctAnswer) {
            g.alpha = 0.75;
            var b = this.add.labelSprite(0, 0, "LondonLevelState/ui/defaultAnswer", style);
            b.setText(text);
            buttonGroup.add(b);
            ...
            var inputHandler = function(b) {
                ...
                b.loadAppropriateTextureForAnswer = function() {
                    this.loadTexture("LondonLevelState" + (correctAnswer ? "/ui/correctAnswer" : "/ui/wrongAnswer"));
                }
